        ...
        <div className="row d-flex">
          <div className="col-md-6">
            <div className="div-3 d-flex flex-column">
              <div className="div-4 d-flex flex-column align-items-start justify-content-between">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/2df73504-0777-4e16-a1fc-9b62a07d75d8?"
          ...
          <div className="col-md-6">
            <div className="column-2 d-flex flex-column mt-5">
              ...
              <div className="p-2 col-12">
                ...
                spesialis mata di almamaternya tersebut dan selesai pada tahun
                2004. Tidak berhenti disitu, beliau melanjutkan pendidikan
                konsultan/subspesialis katarak dan bedah refraktif. Dokter
                Marjis siap melayani dengan sepenuh hati.
              </div>
            </div>
          </div>
        </div>
